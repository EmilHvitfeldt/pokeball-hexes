...
This is a small silly project with the goal of combing two interests of mine (R package hex design + Pokémon), while practicing Illustrator.
...
hexwall <- function(path, sticker_row_size = 4, sticker_width = 500, remove_small = TRUE, total_stickers = NULL, remove_size = TRUE,
